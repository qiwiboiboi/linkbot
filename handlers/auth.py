...
async def process_password(message: Message, state: FSMContext):
    ...
    await message.answer(
        "✅ Успешный вход!\n\n"
        "Добро пожаловать {message.from_user.full_name}. Советуем входить с аккаунта, который не удалится из-за блоковировок. Логин/пароль можно использовать любой аккуант, так что будьте аккуратны.\n\n"
    )
