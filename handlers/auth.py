...
async def process_password(message: Message, state: FSMContext):
    ...
    await message.answer(
        "✅ Успешный вход!\n\n"
        "Теперь вы можете управлять своими ссылками. Советуем входить с аккаунта, который не удалится из-за блоковировок. Логин/пароль можно использовать любой аккуант, так что будьте аккуратны и включайте автоудаление на боте.\n\n"
    )
